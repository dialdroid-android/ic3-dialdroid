...
public class Timers {
  ...
  public void saveTimeToDb() {
    ...
    long mainGenerationTime = mainGeneration.getTime();
    long entryPointMappingTime = entryPointMapping.getTime();
    long totalTime = analysisTimer.getTime();
    long entryPathTime = entryPathTimer.getTime();
